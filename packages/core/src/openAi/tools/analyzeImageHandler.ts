...
export const analyze_image_tool: FunctionTool = {
    ...
    name: 'analyze_image',
    description:
        'Call this tool to describe, identify objects, or read text from an image. Check the conversation history to locate the image the user is asking about before you call this function.',
    parameters: {
        type: 'object',
        properties: {
            prompt: {
